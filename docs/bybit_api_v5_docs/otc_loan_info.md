...
GET`/v5/ins-loan/loan-order`Copy
...
[PreviousGet Margin Coin Info](https://bybit-exchange.github.io/docs/v5/otc/margin-coin-convert-info)[NextGet Repayment Orders](https://bybit-exchange.github.io/docs/v5/otc/repay-info)
