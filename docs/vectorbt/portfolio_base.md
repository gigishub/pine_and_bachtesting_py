...
> **Source:** https://vectorbt.dev/api/portfolio/base/
...
portfolio 
      * base  [ base  ](https://vectorbt.dev/api/portfolio/base/) Table of contents 
        * Workflow 
        * Simulation modes 
          * From orders 
          * From signals 
...
# base module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py "Jump to source")¶

Base class for modeling portfolio and measuring its performance.

Provides the class [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") for modeling portfolio performance and calculating various risk and performance metrics. It uses Numba-compiled functions from [vectorbt.portfolio.nb](https://vectorbt.dev/api/portfolio/nb/ "vectorbt.portfolio.nb") for most computations and record classes based on [Records](https://vectorbt.dev/api/records/base/#vectorbt.records.base.Records "vectorbt.records.base.Records") for evaluating events such as orders, logs, trades, positions, and drawdowns.

The job of the [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") class is to create a series of positions allocated against a cash component, produce an equity curve, incorporate basic transaction costs and produce a set of statistics about its performance. In particular, it outputs position/profit metrics and drawdown information.
...
[Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") class does quite a few things to simulate your strategy.
...
**Construction** phase (in the particular class method):
  ...
  * Receives the returned order records and initializes a new [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") object



**Analysis** phase (in the [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") object)
...
[Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders") is the most straightforward and the fastest out of all simulation modes.

An order is a simple instruction that contains size, price, fees, and other information (see [Order](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order "vectorbt.portfolio.enums.Order") for details about what information a typical order requires). Instead of creating a [Order](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order "vectorbt.portfolio.enums.Order") tuple for each asset and timestamp (which may waste a lot of memory) and appending it to a (potentially huge) list for processing, [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders") takes each of those information pieces as an array, broadcasts them against each other, and creates a [Order](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order "vectorbt.portfolio.enums.Order") tuple out of each element for us.
...
This method is particularly useful in situations where you don't need any further logic apart from filling orders at predefined timestamps. If you want to issue orders depending upon the previous performance, the current state, or other custom conditions, head over to [Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals") or [Portfolio.from_order_func()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_order_func "vectorbt.portfolio.base.Portfolio.from_order_func").

### From signals¶

[Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals") is centered around signals. It adds an abstraction layer on top of [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders") to automate some signaling processes. For example, by default, it won't let us execute another entry signal if we are already in the position. It also implements stop loss and take profit orders for exiting positions. Nevertheless, this method behaves similarly to [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders") and accepts most of its arguments; in fact, by setting `accumulate=True`, it behaves quite similarly to [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
...
There is an even more flexible version available - [flex_simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.flex_simulate_nb "vectorbt.portfolio.nb.flex_simulate_nb") (activated by passing `flexible=True` to [Portfolio.from_order_func()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_order_func "vectorbt.portfolio.base.Portfolio.from_order_func")) - that allows creating multiple orders per symbol and bar.
...
To showcase the features of [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio"), run the following example: it checks candlestick data of 6 major cryptocurrencies in 2020 against every single pattern found in TA-Lib, and translates them into orders.
...
[Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") is very flexible towards inputs:
...
If you look at the arguments of each class method, you will notice that most of them default to None. None has a special meaning in vectorbt: it's a command to pull the default value from the global settings config - [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings"). The branch for the [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") can be found under the key 'portfolio'. For example, the default size used in [Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals") and [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders") is `np.inf`:
...
Like any other class subclassing [Wrapping](https://vectorbt.dev/api/base/array_wrapper/#vectorbt.base.array_wrapper.Wrapping "vectorbt.base.array_wrapper.Wrapping"), we can do pandas indexing on a [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") instance, which forwards indexing operation to each object with columns:
...
Indexing behavior depends solely upon [ArrayWrapper](https://vectorbt.dev/api/base/array_wrapper/#vectorbt.base.array_wrapper.ArrayWrapper "vectorbt.base.array_wrapper.ArrayWrapper"). For example, if `group_select` is enabled indexing will be performed on groups, otherwise on single columns. You can pass wrapper arguments with `wrapper_kwargs`.
...
[Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") heavily relies upon caching. If a method or a property requires heavy computation, it's wrapped with [cached_method()](https://vectorbt.dev/api/utils/decorators/#vectorbt.utils.decorators.cached_method "vectorbt.utils.decorators.cached_method") and [cached_property](https://vectorbt.dev/api/utils/decorators/#vectorbt.utils.decorators.cached_property "vectorbt.utils.decorators.cached_property") respectively. Caching can be disabled globally via `caching` in [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").
...
Alternatively, we can precisely point at attributes and methods that should or shouldn't be cached. For example, we can blacklist the entire [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") class except a few most called methods such as [Portfolio.cash_flow()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.cash_flow "vectorbt.portfolio.base.Portfolio.cash_flow") and [Portfolio.asset_flow()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.asset_flow "vectorbt.portfolio.base.Portfolio.asset_flow"):
...
Define rules for one instance of [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio"):
...
See [should_cache()](https://vectorbt.dev/api/utils/decorators/#vectorbt.utils.decorators.should_cache "vectorbt.utils.decorators.should_cache") for caching rules.
...
If you're running out of memory when working with large arrays, make sure to disable caching and then store most important time series manually. For example, if you're interested in Sharpe ratio or other metrics based on returns, run and save [Portfolio.returns()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.returns "vectorbt.portfolio.base.Portfolio.returns") in a variable and then use the [ReturnsAccessor](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor "vectorbt.returns.accessors.ReturnsAccessor") to analyze them. Do not use methods akin to [Portfolio.sharpe_ratio()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.sharpe_ratio "vectorbt.portfolio.base.Portfolio.sharpe_ratio") because they will re-calculate returns each time.

Alternatively, you can track portfolio value and returns using [Portfolio.from_order_func()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_order_func "vectorbt.portfolio.base.Portfolio.from_order_func") and its callbacks (preferably in `post_segment_func_nb`):
...
Like any other class subclassing [Pickleable](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Pickleable "vectorbt.utils.config.Pickleable"), we can save a [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio") instance to the disk with [Pickleable.save()](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Pickleable.save "vectorbt.portfolio.base.Portfolio.save") and load it with [Pickleable.load()](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Pickleable.load "vectorbt.portfolio.base.Portfolio.load"):
...
Save files won't include neither cached results nor global defaults. For example, passing `fillna_close` as None will also use None when the portfolio is loaded from disk. Make sure to either pass all arguments explicitly or to also save the [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings") config.

## Stats¶

Hint

See [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.generic.stats_builder.StatsBuilderMixin.stats") and [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics").
...
To select metrics, use the `metrics` argument (see [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics") for supported metrics):
...
We can also select specific tags (see any metric from [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics") that has the `tag` key):
...
Let's imagine that the signature of [ReturnsAccessor.sharpe_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.sharpe_ratio "vectorbt.returns.accessors.ReturnsAccessor.sharpe_ratio") doesn't list those arguments: vectorbt would simply call this method without passing those two arguments. In such case, we have two options:
...
In this case, we don't have to pass `resolve_trades=True` any more as vectorbt does it automatically. Another advantage is that vectorbt can access the signature of the last method in the path ([MappedArray.max()](https://vectorbt.dev/api/records/mapped_array/#vectorbt.records.mapped_array.MappedArray.max "vectorbt.records.mapped_array.MappedArray.max") in our case) and resolve its arguments.
...
The first option is to change the [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics") dict in-place (this will append to the end):
...
Since [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics") is of type [Config](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Config "vectorbt.utils.config.Config"), we can reset it at any time to get default metrics:
    
    
    >>> pf.metrics.reset()
    

The second option is to copy [Portfolio.metrics](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.metrics "vectorbt.portfolio.base.Portfolio.metrics"), append our metric, and pass as `metrics` argument:
...
The third option is to set `metrics` globally under `portfolio.stats` in [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").
...
We can compute the stats solely based on the portfolio's returns using [Portfolio.returns_stats()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.returns_stats "vectorbt.portfolio.base.Portfolio.returns_stats"), which calls [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.returns.accessors.ReturnsAccessor.stats").
...
Most metrics defined in [ReturnsAccessor](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor "vectorbt.returns.accessors.ReturnsAccessor") are also available as attributes of [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio"):
...
Moreover, we can access quantstats functions using [QSAdapter](https://vectorbt.dev/api/returns/qs_adapter/#vectorbt.returns.qs_adapter.QSAdapter "vectorbt.returns.qs_adapter.QSAdapter"):
...
The features implemented in this method are very similar to [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.portfolio.base.Portfolio.stats"). See also the examples under [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.portfolio.base.Portfolio.stats").
...
You can choose any of the subplots in [Portfolio.subplots](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.subplots "vectorbt.portfolio.base.Portfolio.subplots"), in any order, and control their appearance using keyword arguments:
...
If a plotting function can in any way be accessed from the current portfolio, you can pass the path to this function (see [deep_getattr()](https://vectorbt.dev/api/utils/attr_/#vectorbt.utils.attr_.deep_getattr "vectorbt.utils.attr_.deep_getattr") for the path format). You can additionally use templates to make some parameters to depend upon passed keyword arguments:
...
## returns_acc_config Config[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py "Jump to source")¶

Config of returns accessor methods to be added to [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").
...
## MetaPortfolio class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L1491-L1492 "Jump to source")¶
...
## Portfolio class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L1495-L5513 "Jump to source")¶
...
See [ArrayWrapper](https://vectorbt.dev/api/base/array_wrapper/#vectorbt.base.array_wrapper.ArrayWrapper "vectorbt.base.array_wrapper.ArrayWrapper").
...
See [Portfolio.get_filled_close()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_filled_close "vectorbt.portfolio.base.Portfolio.get_filled_close").

**`trades_type`** : `str` or `int`
    

Default [Trades](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.Trades "vectorbt.portfolio.trades.Trades") to use across [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").

See [TradesType](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.TradesType "vectorbt.portfolio.enums.TradesType").

For defaults, see `portfolio` in [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").
...
This class is meant to be immutable. To change any attribute, use [Configured.replace()](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Configured.replace "vectorbt.portfolio.base.Portfolio.replace").
...
### alpha method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.alpha()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.alpha "vectorbt.returns.accessors.ReturnsAccessor.alpha").

* * *

### annual_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.annual()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.annual "vectorbt.returns.accessors.ReturnsAccessor.annual").

* * *

### annualized_return method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.annualized()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.annualized "vectorbt.returns.accessors.ReturnsAccessor.annualized").

* * *

### annualized_volatility method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.annualized_volatility()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.annualized_volatility "vectorbt.returns.accessors.ReturnsAccessor.annualized_volatility").

* * *

### asset_flow method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4128-L4140 "Jump to source")¶
...
### asset_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4419-L4431 "Jump to source")¶
...
### asset_value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4277-L4294 "Jump to source")¶
...
### assets method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4142-L4154 "Jump to source")¶
...
### benchmark_rets method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4516-L4523 "Jump to source")¶
...
### benchmark_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4516-L4523 "Jump to source")¶
...
### benchmark_value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4494-L4514 "Jump to source")¶
...
### beta method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.beta()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.beta "vectorbt.returns.accessors.ReturnsAccessor.beta").

* * *

### call_seq property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3995-L4000 "Jump to source")¶

Sequence of calls per row and group.

* * *

### calmar_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.calmar_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.calmar_ratio "vectorbt.returns.accessors.ReturnsAccessor.calmar_ratio").

* * *

### capture method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.capture()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.capture "vectorbt.returns.accessors.ReturnsAccessor.capture").

* * *

### cash method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4240-L4273 "Jump to source")¶
...
See the explanation on `in_sim_order` in [Portfolio.value()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.value "vectorbt.portfolio.base.Portfolio.value"). For `free`, see [Portfolio.cash_flow()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.cash_flow "vectorbt.portfolio.base.Portfolio.cash_flow").

* * *

### cash_flow method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4189-L4207 "Jump to source")¶
...
### cash_sharing property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3990-L3993 "Jump to source")¶

Whether to share cash within the same group.

* * *

### close property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4014-L4017 "Jump to source")¶

Price per unit series.

* * *

### cond_value_at_risk method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.cond_value_at_risk()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.cond_value_at_risk "vectorbt.returns.accessors.ReturnsAccessor.cond_value_at_risk").

* * *

### cumulative_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.cumulative()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.cumulative "vectorbt.returns.accessors.ReturnsAccessor.cumulative").

* * *

### daily_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.daily()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.daily "vectorbt.returns.accessors.ReturnsAccessor.daily").

* * *

### deflated_sharpe_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.deflated_sharpe_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.deflated_sharpe_ratio "vectorbt.returns.accessors.ReturnsAccessor.deflated_sharpe_ratio").

* * *

### down_capture method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.down_capture()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.down_capture "vectorbt.returns.accessors.ReturnsAccessor.down_capture").

* * *

### downside_risk method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.downside_risk()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.downside_risk "vectorbt.returns.accessors.ReturnsAccessor.downside_risk").

* * *

### drawdown method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.drawdown()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.drawdown "vectorbt.returns.accessors.ReturnsAccessor.drawdown").

* * *

### drawdowns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_drawdowns()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_drawdowns "vectorbt.portfolio.base.Portfolio.get_drawdowns") with default arguments.

* * *

### entry_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_entry_trades()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_entry_trades "vectorbt.portfolio.base.Portfolio.get_entry_trades") with default arguments.

* * *

### exit_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_exit_trades()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_exit_trades "vectorbt.portfolio.base.Portfolio.get_exit_trades") with default arguments.

* * *

### fillna_close property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4002-L4005 "Jump to source")¶

Whether to forward-backward fill NaN values in [Portfolio.close](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.close "vectorbt.portfolio.base.Portfolio.close").

* * *

### final_value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4380-L4388 "Jump to source")¶
...
### from_holding class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3023-L3035 "Jump to source")¶
...
Based on [Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals").
...
### from_order_func class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3144-L3963 "Jump to source")¶
...
See [simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_nb "vectorbt.portfolio.nb.simulate_nb") for illustrations and argument definitions.

For more details on individual simulation functions:

  * not `row_wise` and not `flexible`: See [simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_nb "vectorbt.portfolio.nb.simulate_nb")
  * not `row_wise` and `flexible`: See [flex_simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.flex_simulate_nb "vectorbt.portfolio.nb.flex_simulate_nb")
  * `row_wise` and not `flexible`: See [simulate_row_wise_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_row_wise_nb "vectorbt.portfolio.nb.simulate_row_wise_nb")
  * `row_wise` and `flexible`: See [flex_simulate_row_wise_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.flex_simulate_row_wise_nb "vectorbt.portfolio.nb.flex_simulate_row_wise_nb")
...
See `init_cash` in [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
...
Default sequence of calls per row and group.
  ...
  * Use [CallSeqType](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.CallSeqType "vectorbt.portfolio.enums.CallSeqType") to select a sequence type.
...
CallSeqType.Auto should be implemented manually. Use [sort_call_seq_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.sort_call_seq_nb "vectorbt.portfolio.nb.sort_call_seq_nb") or [sort_call_seq_out_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.sort_call_seq_out_nb "vectorbt.portfolio.nb.sort_call_seq_out_nb") in `pre_segment_func_nb`.
...
**`pre_sim_func_nb`** : `callable`
    Function called before simulation. Defaults to [no_pre_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_pre_func_nb "vectorbt.portfolio.nb.no_pre_func_nb").
**`pre_sim_args`** : `tuple`
    Packed arguments passed to `pre_sim_func_nb`. Defaults to `()`.
**`post_sim_func_nb`** : `callable`
    Function called after simulation. Defaults to [no_post_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_post_func_nb "vectorbt.portfolio.nb.no_post_func_nb").
**`post_sim_args`** : `tuple`
    Packed arguments passed to `post_sim_func_nb`. Defaults to `()`.
**`pre_group_func_nb`** : `callable`
    

Function called before each group. Defaults to [no_pre_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_pre_func_nb "vectorbt.portfolio.nb.no_pre_func_nb").
...
Function called after each group. Defaults to [no_post_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_post_func_nb "vectorbt.portfolio.nb.no_post_func_nb").
...
Function called before each row. Defaults to [no_pre_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_pre_func_nb "vectorbt.portfolio.nb.no_pre_func_nb").
...
Function called after each row. Defaults to [no_post_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_post_func_nb "vectorbt.portfolio.nb.no_post_func_nb").
...
**`pre_segment_func_nb`** : `callable`
    Function called before each segment. Defaults to [no_pre_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_pre_func_nb "vectorbt.portfolio.nb.no_pre_func_nb").
**`pre_segment_args`** : `tuple`
    Packed arguments passed to `pre_segment_func_nb`. Defaults to `()`.
**`post_segment_func_nb`** : `callable`
    Function called after each segment. Defaults to [no_post_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_post_func_nb "vectorbt.portfolio.nb.no_post_func_nb").
...
**`seed`** : `int`
    See [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
**`group_by`** : `any`
    See [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
**`broadcast_named_args`** : `dict`
    See [Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals").
...
Also see notes on [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
...
**Usage**
  ...
  * Equal-weighted portfolio as in the example under [simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_nb "vectorbt.portfolio.nb.simulate_nb"):
...
### from_orders class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L1600-L2019 "Jump to source")¶
...
**`size`** : `float` or `array_like`
    Size to order. See [Order.size](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.size "vectorbt.portfolio.enums.Order.size"). Will broadcast.
**`size_type`** : `SizeType` or `array_like`
    

See [SizeType](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.SizeType "vectorbt.portfolio.enums.SizeType"). See [Order.size_type](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.size_type "vectorbt.portfolio.enums.Order.size_type"). Will broadcast.
...
**`direction`** : `Direction` or `array_like`
    See [Direction](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Direction "vectorbt.portfolio.enums.Direction"). See [Order.direction](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.direction "vectorbt.portfolio.enums.Order.direction"). Will broadcast.
**`price`** : `array_like` of `float`
    

Order price. See [Order.price](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.price "vectorbt.portfolio.enums.Order.price"). Defaults to `np.inf`. Will broadcast.
...
**`fees`** : `float` or `array_like`
    Fees in percentage of the order value. See [Order.fees](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.fees "vectorbt.portfolio.enums.Order.fees"). Will broadcast.
**`fixed_fees`** : `float` or `array_like`
    Fixed amount of fees to pay per order. See [Order.fixed_fees](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.fixed_fees "vectorbt.portfolio.enums.Order.fixed_fees"). Will broadcast.
**`slippage`** : `float` or `array_like`
    Slippage in percentage of price. See [Order.slippage](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.slippage "vectorbt.portfolio.enums.Order.slippage"). Will broadcast.
**`min_size`** : `float` or `array_like`
    Minimum size for an order to be accepted. See [Order.min_size](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.min_size "vectorbt.portfolio.enums.Order.min_size"). Will broadcast.
**`max_size`** : `float` or `array_like`
    

Maximum size for an order. See [Order.max_size](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.max_size "vectorbt.portfolio.enums.Order.max_size"). Will broadcast.

Will be partially filled if exceeded.

**`size_granularity`** : `float` or `array_like`
    Granularity of the size. See [Order.size_granularity](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.size_granularity "vectorbt.portfolio.enums.Order.size_granularity"). Will broadcast.
**`reject_prob`** : `float` or `array_like`
    Order rejection probability. See [Order.reject_prob](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.reject_prob "vectorbt.portfolio.enums.Order.reject_prob"). Will broadcast.
**`lock_cash`** : `bool` or `array_like`
    Whether to lock cash when shorting. See [Order.lock_cash](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.lock_cash "vectorbt.portfolio.enums.Order.lock_cash"). Will broadcast.
**`allow_partial`** : `bool` or `array_like`
    

Whether to allow partial fills. See [Order.allow_partial](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.allow_partial "vectorbt.portfolio.enums.Order.allow_partial"). Will broadcast.

Does not apply when size is `np.inf`.

**`raise_reject`** : `bool` or `array_like`
    Whether to raise an exception if order gets rejected. See [Order.raise_reject](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.raise_reject "vectorbt.portfolio.enums.Order.raise_reject"). Will broadcast.
**`log`** : `bool` or `array_like`
    Whether to log orders. See [Order.log](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Order.log "vectorbt.portfolio.enums.Order.log"). Will broadcast.
...
In contrast to [Portfolio.from_order_func()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_order_func "vectorbt.portfolio.base.Portfolio.from_order_func"), order price is known beforehand (kind of), thus `val_price` is set to the current order price (using `np.inf`) by default. To valuate using previous close, set it in the settings to `-np.inf`.
...
By default, will broadcast to the number of columns. If cash sharing is enabled, will broadcast to the number of groups. See [InitCashMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.InitCashMode "vectorbt.portfolio.enums.InitCashMode") to find optimal initial cash.
...
For more control, use [Portfolio.from_order_func()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_order_func "vectorbt.portfolio.base.Portfolio.from_order_func").
...
**`group_by`** : `any`
    Group columns. See [ColumnGrouper](https://vectorbt.dev/api/base/column_grouper/#vectorbt.base.column_grouper.ColumnGrouper "vectorbt.base.column_grouper.ColumnGrouper").
**`broadcast_kwargs`** : `dict`
    Keyword arguments passed to [broadcast()](https://vectorbt.dev/api/base/reshape_fns/#vectorbt.base.reshape_fns.broadcast "vectorbt.base.reshape_fns.broadcast").
**`wrapper_kwargs`** : `dict`
...
All broadcastable arguments will broadcast using [broadcast()](https://vectorbt.dev/api/base/reshape_fns/#vectorbt.base.reshape_fns.broadcast "vectorbt.base.reshape_fns.broadcast") but keep original shape to utilize flexible indexing and to save memory.
...
**Usage**
  ...
  * Equal-weighted portfolio as in [simulate_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_nb "vectorbt.portfolio.nb.simulate_nb") example (it's more compact but has less control over execution):
...
### from_random_signals class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3037-L3142 "Jump to source")¶
...
Generates signals based either on the number of signals `n` or the probability of encountering a signal `prob`.
  ...
  * If `n` is set, see [RANDNX](https://vectorbt.dev/api/signals/generators/#vectorbt.signals.generators.RANDNX "vectorbt.signals.generators.RANDNX").
  * If `prob` is set, see [RPROBNX](https://vectorbt.dev/api/signals/generators/#vectorbt.signals.generators.RPROBNX "vectorbt.signals.generators.RPROBNX").
...
### from_signals class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L2021-L3021 "Jump to source")¶
...
See [simulate_from_signal_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.simulate_from_signal_func_nb "vectorbt.portfolio.nb.simulate_from_signal_func_nb").
...
Uses [dir_enex_signal_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.dir_enex_signal_func_nb "vectorbt.portfolio.nb.dir_enex_signal_func_nb") as `signal_func_nb`.
...
Uses [ls_enex_signal_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.ls_enex_signal_func_nb "vectorbt.portfolio.nb.ls_enex_signal_func_nb") as `signal_func_nb`.
...
Should accept [SignalContext](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.SignalContext "vectorbt.portfolio.enums.SignalContext") and `*signal_args`. Should return long entry signal, long exit signal, short entry signal, and short exit signal.
...
See warning in [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
...
See [AccumulationMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.AccumulationMode "vectorbt.portfolio.enums.AccumulationMode"). If True, becomes 'both'. If False, becomes 'disabled'. Will broadcast.

When enabled, [Portfolio.from_signals()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_signals "vectorbt.portfolio.base.Portfolio.from_signals") behaves similarly to [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").

**`upon_long_conflict`** : `ConflictMode` or `array_like`
    Conflict mode for long signals. See [ConflictMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.ConflictMode "vectorbt.portfolio.enums.ConflictMode"). Will broadcast.
**`upon_short_conflict`** : `ConflictMode` or `array_like`
    Conflict mode for short signals. See [ConflictMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.ConflictMode "vectorbt.portfolio.enums.ConflictMode"). Will broadcast.
**`upon_dir_conflict`** : `DirectionConflictMode` or `array_like`
    See [DirectionConflictMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.DirectionConflictMode "vectorbt.portfolio.enums.DirectionConflictMode"). Will broadcast.
**`upon_opposite_entry`** : `OppositeEntryMode` or `array_like`
    See [OppositeEntryMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.OppositeEntryMode "vectorbt.portfolio.enums.OppositeEntryMode"). Will broadcast.
**`direction`** : `Direction` or `array_like`
...
See [StopEntryPrice](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.StopEntryPrice "vectorbt.portfolio.enums.StopEntryPrice"). Will broadcast.
...
See [StopExitPrice](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.StopExitPrice "vectorbt.portfolio.enums.StopExitPrice"). Will broadcast.
...
See [StopExitMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.StopExitMode "vectorbt.portfolio.enums.StopExitMode"). Will broadcast.
...
See [StopUpdateMode](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.StopUpdateMode "vectorbt.portfolio.enums.StopUpdateMode"). Will broadcast.
...
Function to adjust stop loss. Defaults to [no_adjust_sl_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_adjust_sl_func_nb "vectorbt.portfolio.nb.no_adjust_sl_func_nb").

Called for each element before each row.

Should accept [AdjustSLContext](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.AdjustSLContext "vectorbt.portfolio.enums.AdjustSLContext") and `*adjust_sl_args`. Should return a tuple of a new stop value and trailing flag.
...
Function to adjust take profit. Defaults to [no_adjust_tp_func_nb()](https://vectorbt.dev/api/portfolio/nb/#vectorbt.portfolio.nb.no_adjust_tp_func_nb "vectorbt.portfolio.nb.no_adjust_tp_func_nb").

Called for each element before each row.

Should accept [AdjustTPContext](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.AdjustTPContext "vectorbt.portfolio.enums.AdjustTPContext") and `*adjust_tp_args`. of the stop, and `*adjust_tp_args`. Should return a new stop value.
...
Also see notes and hints for [Portfolio.from_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.from_orders "vectorbt.portfolio.base.Portfolio.from_orders").
...
See [StopExitPrice](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.StopExitPrice "vectorbt.portfolio.enums.StopExitPrice") for more details.

  * We can implement our own stop loss or take profit, or adjust the existing one at each time step. Let's implement [stepped stop-loss](https://www.freqtrade.io/en/stable/strategy-advanced/#stepped-stoploss):
...
### get_drawdowns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4116-L4124 "Jump to source")¶
...
Get drawdown records from [Portfolio.value()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.value "vectorbt.portfolio.base.Portfolio.value").
...
### get_entry_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4066-L4071 "Jump to source")¶
...
See [EntryTrades](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.EntryTrades "vectorbt.portfolio.trades.EntryTrades").

* * *

### get_exit_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4078-L4083 "Jump to source")¶
...
See [ExitTrades](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.ExitTrades "vectorbt.portfolio.trades.ExitTrades").

* * *

### get_filled_close method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4019-L4023 "Jump to source")¶
...
Forward-backward-fill NaN values in [Portfolio.close](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.close "vectorbt.portfolio.base.Portfolio.close")

* * *

### get_init_cash method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4214-L4238 "Jump to source")¶
...
### get_logs method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4054-L4059 "Jump to source")¶
...
See [Logs](https://vectorbt.dev/api/portfolio/logs/#vectorbt.portfolio.logs.Logs "vectorbt.portfolio.logs.Logs").

* * *

### get_orders method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4037-L4042 "Jump to source")¶
...
See [Orders](https://vectorbt.dev/api/portfolio/orders/#vectorbt.portfolio.orders.Orders "vectorbt.portfolio.orders.Orders").

* * *

### get_positions method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4095-L4100 "Jump to source")¶
...
See [Positions](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.Positions "vectorbt.portfolio.trades.Positions").

* * *

### get_qs method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4472-L4492 "Jump to source")¶
...
Get quantstats adapter of type [QSAdapter](https://vectorbt.dev/api/returns/qs_adapter/#vectorbt.returns.qs_adapter.QSAdapter "vectorbt.returns.qs_adapter.QSAdapter").

`**kwargs` are passed to the adapter constructor.

* * *

### get_returns_acc method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4438-L4465 "Jump to source")¶
...
Get returns accessor of type [ReturnsAccessor](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor "vectorbt.returns.accessors.ReturnsAccessor").
...
### get_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4102-L4109 "Jump to source")¶
...
Get trade/position records depending upon [Portfolio.trades_type](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.trades_type "vectorbt.portfolio.base.Portfolio.trades_type").

* * *

### gross_exposure method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4296-L4314 "Jump to source")¶
...
### indexing_func method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L1573-L1596 "Jump to source")¶
...
Perform indexing on [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").

* * *

### information_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.information_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.information_ratio "vectorbt.returns.accessors.ReturnsAccessor.information_ratio").

* * *

### init_cash method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_init_cash()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_init_cash "vectorbt.portfolio.base.Portfolio.get_init_cash") with default arguments.

* * *

### log_records property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4044-L4047 "Jump to source")¶

A structured NumPy array of log records.

* * *

### logs method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_logs()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_logs "vectorbt.portfolio.base.Portfolio.get_logs") with default arguments.

* * *

### max_drawdown method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.max_drawdown()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.max_drawdown "vectorbt.returns.accessors.ReturnsAccessor.max_drawdown").

* * *

### metrics class variable[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py "Jump to source")¶

Metrics supported by [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").
    
    
    Config({
        "start": {
            "title": "Start",
            "calc_func": "<function Portfolio.<lambda> at 0x7f957f495760>",
            "agg_func": null,
            "tags": "wrapper"
        },
        "end": {
            "title": "End",
            "calc_func": "<function Portfolio.<lambda> at 0x7f957f495800>",
            "agg_func": null,
            "tags": "wrapper"
        },
        "period": {
            "title": "Period",
            "calc_func": "<function Portfolio.<lambda> at 0x7f957f4958a0>",
        ...
        "total_return": {
            ...
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495940>",
            "tags": "portfolio"
        },
        "benchmark_return": {
            "title": "Benchmark Return [%]",
            "calc_func": "benchmark_rets.vbt.returns.total",
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f4959e0>",
            "tags": "portfolio"
        },
        "max_gross_exposure": {
            "title": "Max Gross Exposure [%]",
            "calc_func": "gross_exposure.vbt.max",
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495a80>",
            "tags": "portfolio"
        },
        "total_fees_paid": {
        ...
        "max_dd": {
            ...
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495b20>",
            "tags": [
                "portfolio",
                "drawdowns"
            ]
        ...
        "win_rate": {
            ...
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495bc0>",
            "tags": "RepEval(expression=\"['portfolio', 'trades', *incl_open_tags]\", mapping={})"
        },
        "best_trade": {
            "title": "Best Trade [%]",
            "calc_func": "trades.returns.max",
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495c60>",
            "tags": "RepEval(expression=\"['portfolio', 'trades', *incl_open_tags]\", mapping={})"
        },
        "worst_trade": {
            "title": "Worst Trade [%]",
            "calc_func": "trades.returns.min",
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495d00>",
            "tags": "RepEval(expression=\"['portfolio', 'trades', *incl_open_tags]\", mapping={})"
        },
        "avg_winning_trade": {
            "title": "Avg Winning Trade [%]",
            "calc_func": "trades.winning.returns.mean",
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495da0>",
        ...
        "avg_losing_trade": {
            ...
            "post_calc_func": "<function Portfolio.<lambda> at 0x7f957f495e40>",
...
### net_exposure method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4316-L4323 "Jump to source")¶
...
### omega_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.omega_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.omega_ratio "vectorbt.returns.accessors.ReturnsAccessor.omega_ratio").

* * *

### order_records property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4027-L4030 "Jump to source")¶

A structured NumPy array of order records.

* * *

### orders method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_orders()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_orders "vectorbt.portfolio.base.Portfolio.get_orders") with default arguments.

* * *

### plot method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/plots_builder.py#L79-L672 "Jump to source")¶
...
### plot_asset_flow method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4827-L4872 "Jump to source")¶
...
**`**kwargs`**
    Keyword arguments passed to [GenericAccessor.plot()](https://vectorbt.dev/api/generic/accessors/#vectorbt.generic.accessors.GenericAccessor.plot "vectorbt.generic.accessors.GenericAccessor.plot").

* * *

### plot_asset_value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5035-L5089 "Jump to source")¶
...
**`group_by`** : `any`
    Group or ungroup columns. See [ColumnGrouper](https://vectorbt.dev/api/base/column_grouper/#vectorbt.base.column_grouper.ColumnGrouper "vectorbt.base.column_grouper.ColumnGrouper").
**`direction`** : `Direction`
    See [Direction](https://vectorbt.dev/api/portfolio/enums/#vectorbt.portfolio.enums.Direction "vectorbt.portfolio.enums.Direction").
**`xref`** : `str`
    X coordinate axis.
...
**`hline_shape_kwargs`** : `dict`
    Keyword arguments passed to `plotly.graph_objects.Figure.add_shape` for zeroline.
**`**kwargs`**
    Keyword arguments passed to [GenericSRAccessor.plot_against()](https://vectorbt.dev/api/generic/accessors/#vectorbt.generic.accessors.GenericSRAccessor.plot_against "vectorbt.generic.accessors.GenericSRAccessor.plot_against").

* * *

### plot_assets method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4923-L4975 "Jump to source")¶
...
### plot_cash method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4977-L5033 "Jump to source")¶
...
### plot_cash_flow method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4874-L4921 "Jump to source")¶
...
### plot_cum_returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5142-L5190 "Jump to source")¶
...
If None, will use [Portfolio.benchmark_returns()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.benchmark_returns "vectorbt.portfolio.base.Portfolio.benchmark_returns").

**`use_asset_returns`** : `bool`
    Whether to plot asset returns.
**`**kwargs`**
    Keyword arguments passed to [ReturnsSRAccessor.plot_cumulative()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsSRAccessor.plot_cumulative "vectorbt.returns.accessors.ReturnsSRAccessor.plot_cumulative").

* * *

### plot_drawdowns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5192-L5214 "Jump to source")¶
...
**`group_by`** : `any`
    Group or ungroup columns. See [ColumnGrouper](https://vectorbt.dev/api/base/column_grouper/#vectorbt.base.column_grouper.ColumnGrouper "vectorbt.base.column_grouper.ColumnGrouper").
**`**kwargs`**
    Keyword arguments passed to [Drawdowns.plot()](https://vectorbt.dev/api/generic/drawdowns/#vectorbt.generic.drawdowns.Drawdowns.plot "vectorbt.generic.drawdowns.Drawdowns.plot").

* * *

### plot_gross_exposure method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5267-L5321 "Jump to source")¶
...
### plot_net_exposure method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5323-L5375 "Jump to source")¶
...
### plot_orders method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4804-L4807 "Jump to source")¶
...
### plot_position_pnl method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4823-L4825 "Jump to source")¶
...
### plot_positions method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4818-L4821 "Jump to source")¶
...
### plot_trade_pnl method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4814-L4816 "Jump to source")¶
...
### plot_trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4809-L4812 "Jump to source")¶
...
### plot_underwater method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5216-L5265 "Jump to source")¶
...
### plot_value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5091-L5140 "Jump to source")¶
...
### plots_defaults property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L5377-L5396 "Jump to source")¶

Defaults for [PlotsBuilderMixin.plots()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.plot "vectorbt.portfolio.base.Portfolio.plot").

Merges [PlotsBuilderMixin.plots_defaults](https://vectorbt.dev/api/generic/plots_builder/#vectorbt.generic.plots_builder.PlotsBuilderMixin.plots_defaults "vectorbt.generic.plots_builder.PlotsBuilderMixin.plots_defaults") and `portfolio.plots` from [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").

* * *

### position_coverage method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4172-L4185 "Jump to source")¶
...
### position_mask method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4156-L4170 "Jump to source")¶
...
### positions method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_positions()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_positions "vectorbt.portfolio.base.Portfolio.get_positions") with default arguments.

* * *

### post_resolve_attr method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4566-L4576 "Jump to source")¶
...
Uses the following keys:
  ...
  * `incl_open`: Whether to include open trades/positions when resolving an argument that is an instance of [Trades](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.Trades "vectorbt.portfolio.trades.Trades").



* * *

### pre_resolve_attr method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4543-L4564 "Jump to source")¶
...
Uses the following keys:
  ...
  * `use_asset_returns`: Whether to use [Portfolio.asset_returns()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.asset_returns "vectorbt.portfolio.base.Portfolio.asset_returns") when resolving `returns` argument.
...
### qs method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_qs()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_qs "vectorbt.portfolio.base.Portfolio.get_qs") with default arguments.

* * *

### regroup method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L3978-L3988 "Jump to source")¶
...
See [Wrapping.regroup()](https://vectorbt.dev/api/base/array_wrapper/#vectorbt.base.array_wrapper.Wrapping.regroup "vectorbt.base.array_wrapper.Wrapping.regroup").
...
### returns method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4400-L4417 "Jump to source")¶
...
### returns_acc property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4433-L4436 "Jump to source")¶

[Portfolio.get_returns_acc()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_returns_acc "vectorbt.portfolio.base.Portfolio.get_returns_acc") with default arguments.

* * *

### returns_stats method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4778-L4800 "Jump to source")¶
...
See [Portfolio.returns_acc](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.returns_acc "vectorbt.portfolio.base.Portfolio.returns_acc") and [ReturnsAccessor.metrics](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.metrics "vectorbt.returns.accessors.ReturnsAccessor.metrics").

`kwargs` will be passed to [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.returns.accessors.ReturnsAccessor.stats") method. If `benchmark_rets` is not set, uses [Portfolio.benchmark_returns()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.benchmark_returns "vectorbt.portfolio.base.Portfolio.benchmark_returns").

* * *

### sharpe_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.sharpe_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.sharpe_ratio "vectorbt.returns.accessors.ReturnsAccessor.sharpe_ratio").

* * *

### sortino_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.sortino_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.sortino_ratio "vectorbt.returns.accessors.ReturnsAccessor.sortino_ratio").

* * *

### stats_defaults property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4580-L4599 "Jump to source")¶

Defaults for [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.portfolio.base.Portfolio.stats").

Merges [StatsBuilderMixin.stats_defaults](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats_defaults "vectorbt.generic.stats_builder.StatsBuilderMixin.stats_defaults") and `portfolio.stats` from [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").

* * *

### subplots class variable[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py "Jump to source")¶

Subplots supported by [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").
...
### tail_ratio method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.tail_ratio()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.tail_ratio "vectorbt.returns.accessors.ReturnsAccessor.tail_ratio").

* * *

### total_benchmark_return method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4527-L4534 "Jump to source")¶
...
### total_profit method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4353-L4378 "Jump to source")¶
...
### total_return method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4390-L4398 "Jump to source")¶
...
### trades method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

[Portfolio.get_trades()](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio.get_trades "vectorbt.portfolio.base.Portfolio.get_trades") with default arguments.

* * *

### trades_type property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4007-L4010 "Jump to source")¶

Default [Trades](https://vectorbt.dev/api/portfolio/trades/#vectorbt.portfolio.trades.Trades "vectorbt.portfolio.trades.Trades") to use across [Portfolio](https://vectorbt.dev/api/portfolio/base/#vectorbt.portfolio.base.Portfolio "vectorbt.portfolio.base.Portfolio").

* * *

### up_capture method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.up_capture()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.up_capture "vectorbt.returns.accessors.ReturnsAccessor.up_capture").

* * *

### value method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/base.py#L4325-L4351 "Jump to source")¶
...
When `group_by` is False and `in_sim_order` is True, returns value generated in simulation order (see [row-major order](https://en.wikipedia.org/wiki/Row-_and_column-major_order). This value cannot be used for generating returns as-is. Useful to analyze how value evolved throughout simulation.

* * *

### value_at_risk method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/portfolio/decorators.py#L32-L48 "Jump to source")¶
...
See [ReturnsAccessor.value_at_risk()](https://vectorbt.dev/api/returns/accessors/#vectorbt.returns.accessors.ReturnsAccessor.value_at_risk "vectorbt.returns.accessors.ReturnsAccessor.value_at_risk").
