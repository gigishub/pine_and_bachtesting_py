...
GET`/v5/asset/delivery-record`Copy

### Request Parameters​

Parameter| Required| Type| Comments  
---|---|---|---  
[category](https://bybit-exchange.github.io/docs/v5/enum#category)| **true**|  string| Product type `inverse`(inverse futures), `linear`(USDT/USDC futures), `option`  
...
[PreviousFunding Account Transaction History](https://bybit-exchange.github.io/docs/v5/asset/fund-history)[NextGet USDC Session Settlement (2 years)](https://bybit-exchange.github.io/docs/v5/asset/settlement)
