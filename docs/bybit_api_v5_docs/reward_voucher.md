...
POST`/v5/broker/award/info`Copy
...
[PreviousGet All Rate Limits](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-all)[NextIssue Voucher](https://bybit-exchange.github.io/docs/v5/broker/reward/issue-voucher)
