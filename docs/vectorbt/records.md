...
> **Source:** https://vectorbt.dev/api/records/
...
# records package[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/records/__init__.py "Jump to source")¶

Modules for working with records.

Records are the second form of data representation in vectorbt. They allow storing sparse event data such as drawdowns, orders, trades, and positions, without converting them back to the matrix form and occupying the user's memory.

* * *

## Sub-modules¶

  * [vectorbt.records.base](https://vectorbt.dev/api/records/base/ "vectorbt.records.base")
  * [vectorbt.records.col_mapper](https://vectorbt.dev/api/records/col_mapper/ "vectorbt.records.col_mapper")
  * [vectorbt.records.decorators](https://vectorbt.dev/api/records/decorators/ "vectorbt.records.decorators")
  * [vectorbt.records.mapped_array](https://vectorbt.dev/api/records/mapped_array/ "vectorbt.records.mapped_array")
  * [vectorbt.records.nb](https://vectorbt.dev/api/records/nb/ "vectorbt.records.nb")
