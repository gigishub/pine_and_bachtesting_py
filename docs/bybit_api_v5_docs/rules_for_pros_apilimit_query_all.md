...
> **Source:** https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-all
...
GET`/v5/apilimit/query-all`Copy
...
[PreviousGet Rate Limit Cap](https://bybit-exchange.github.io/docs/v5/rate-limit/rules-for-pros/apilimit-query-cap)[NextEnums Definitions](https://bybit-exchange.github.io/docs/v5/enum)
