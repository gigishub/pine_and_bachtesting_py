...
POST`/v5/broker/apilimit/set`Copy
...
[PreviousIntroduction](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/introduction)[NextGet Rate Limit Cap](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/query-cap)
