...
> **Source:** https://bybit-exchange.github.io/docs/v5/pre-upgrade/execution
...
GET`/v5/pre-upgrade/execution/list`Copy
...
[PreviousGet Pre-upgrade Order History](https://bybit-exchange.github.io/docs/v5/pre-upgrade/order-list)[NextGet Pre-upgrade Closed PnL](https://bybit-exchange.github.io/docs/v5/pre-upgrade/close-pnl)
