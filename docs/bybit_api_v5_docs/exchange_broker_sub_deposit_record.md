...
GET`/v5/broker/asset/query-sub-member-deposit-record`Copy
...
[PreviousGet Account Info](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/account-info)[NextIntroduction](https://bybit-exchange.github.io/docs/v5/broker/exchange-broker/rate-limit/introduction)
