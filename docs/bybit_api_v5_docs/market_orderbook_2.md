...
> **Source:** https://bybit-exchange.github.io/docs/v5/spread/market/orderbook
...
cts| integer| The timestamp from the matching engine when this orderbook data is produced. It can be correlated with `T` from [public trade channel](https://bybit-exchange.github.io/docs/v5/spread/websocket/public/trade)  
...
[PreviousGet Instruments Info](https://bybit-exchange.github.io/docs/v5/spread/market/instrument)[NextGet Tickers](https://bybit-exchange.github.io/docs/v5/spread/market/tickers)
