...
GET`/v5/ins-loan/product-infos`Copy
...
[PreviousGet Loan LTV Adjustment History](https://bybit-exchange.github.io/docs/v5/crypto-loan/ltv-adjust-history)[NextGet Margin Coin Info](https://bybit-exchange.github.io/docs/v5/otc/margin-coin-convert-info)
