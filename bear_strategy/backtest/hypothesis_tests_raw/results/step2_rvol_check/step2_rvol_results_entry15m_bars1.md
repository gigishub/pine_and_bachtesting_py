...
── RVOL Setup Edge Verdict ──
  ...
  rvol_spike              avg WR lift +0.47pp  avg PF 1.190  avg PF lift +0.022  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 43.38%  lift +0.71pp / req 0.80pp  PF 1.149  lift +0.033 / req 0.050  trades 24,108  cov 25.6%  ❌
    ETHUSDT     WR 44.28%  lift +0.68pp / req 0.79pp  PF 1.192  lift +0.033 / req 0.050  trades 24,676  cov 25.8%  ❌
    SOLUSDT     WR 44.65%  lift +0.75pp / req 0.81pp  PF 1.210  lift +0.036 / req 0.050  trades 23,685  cov 26.4%  ❌
    BNBUSDT     WR 43.39%  lift +0.00pp / req 0.84pp  PF 1.150  lift +0.000 / req 0.050  trades 21,591  cov 26.7%  ❌
    XRPUSDT     WR 45.42%  lift +0.19pp / req 0.78pp  PF 1.248  lift +0.010 / req 0.050  trades 25,566  cov 26.0%  ❌

  rvol_spike_bearish      avg WR lift +0.37pp  avg PF 1.185  avg PF lift +0.018  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 42.65%  lift -0.02pp / req 1.11pp  PF 1.116  lift -0.001 / req 0.050  trades 12,430  cov 13.2% ⚠️  ❌
    ETHUSDT     WR 44.67%  lift +1.07pp / req 1.09pp  PF 1.211  lift +0.051 / req 0.050  trades 12,940  cov 13.5% ⚠️  ❌
    SOLUSDT     WR 44.56%  lift +0.66pp / req 1.11pp  PF 1.206  lift +0.032 / req 0.050  trades 12,422  cov 13.9% ⚠️  ❌
    BNBUSDT     WR 43.34%  lift -0.05pp / req 1.18pp  PF 1.147  lift -0.002 / req 0.050  trades 10,946  cov 13.5% ⚠️  ❌
    XRPUSDT     WR 45.40%  lift +0.17pp / req 1.07pp  PF 1.247  lift +0.008 / req 0.050  trades 13,643  cov 13.9% ⚠️  ❌

  rvol_spike_down         avg WR lift +0.37pp  avg PF 1.185  avg PF lift +0.018  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 42.65%  lift -0.02pp / req 1.11pp  PF 1.116  lift -0.001 / req 0.050  trades 12,430  cov 13.2% ⚠️  ❌
    ETHUSDT     WR 44.67%  lift +1.07pp / req 1.09pp  PF 1.211  lift +0.051 / req 0.050  trades 12,940  cov 13.5% ⚠️  ❌
    SOLUSDT     WR 44.56%  lift +0.66pp / req 1.11pp  PF 1.206  lift +0.032 / req 0.050  trades 12,422  cov 13.9% ⚠️  ❌
    BNBUSDT     WR 43.34%  lift -0.05pp / req 1.18pp  PF 1.147  lift -0.002 / req 0.050  trades 10,946  cov 13.5% ⚠️  ❌
