...
> **Source:** https://bybit-exchange.github.io/docs/v5/user/modify-master-apikey
...
[PreviousGet UID Wallet Type](https://bybit-exchange.github.io/docs/v5/user/wallet-type)[NextModify Sub API Key](https://bybit-exchange.github.io/docs/v5/user/modify-sub-apikey)
