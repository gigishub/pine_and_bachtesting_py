...
> **Source:** https://bybit-exchange.github.io/docs/v5/asset/withdraw/withdraw-record
...
GET`/v5/asset/withdraw/query-record`Copy
...
> [status](https://bybit-exchange.github.io/docs/v5/enum#withdrawstatus)| string| Withdraw status  
...
[RUN >>](https://bybit-exchange.github.io/docs/api-explorer/v5/asset/withdraw-record)
...
[PreviousGet Withdrawal Address List](https://bybit-exchange.github.io/docs/v5/asset/withdraw/withdraw-address)[NextGet available VASPs](https://bybit-exchange.github.io/docs/v5/asset/withdraw/vasp-list)
