...
> **Source:** https://bybit-exchange.github.io/docs/v5/order/batch-place
...
> [tpTriggerBy](https://bybit-exchange.github.io/docs/v5/enum#triggerby)| false| string| The price type to trigger take profit. `MarkPrice`, `IndexPrice`, default: `LastPrice`.  
Valid for `linear`, `inverse`  
> [slTriggerBy](https://bybit-exchange.github.io/docs/v5/enum#triggerby)| false| string| The price type to trigger stop loss. `MarkPrice`, `IndexPrice`, default: `LastPrice`  
Valid for `linear`, `inverse`  
...
[PreviousGet Trade History (2 years)](https://bybit-exchange.github.io/docs/v5/order/execution)[NextBatch Amend Order](https://bybit-exchange.github.io/docs/v5/order/batch-amend)
