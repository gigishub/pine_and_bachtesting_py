"""Vectorized outcome engine for Setup 2 – Trigger 3: oscillator and BB signals.
...
from bear_strategy.hypothesis_tests.setup_2_trigger_3_check.entries import build_population_masks
...
def run_test(config: TestConfig) -> pd.DataFrame:
    """Run the trigger-3 check across all configured pairs."""
    params = Parameters(
