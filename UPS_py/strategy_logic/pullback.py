...
def compute_pullback_state_series(
    ...
    for t in range(n):
        ...
        bullish_pb_now = _pullback_bar_count(open_arr, close_arr, t, lb_bull, 1) >= 2
        bearish_pb_now = _pullback_bar_count(open_arr, close_arr, t, lb_bear, -1) >= 2
        bullish_pb[t] = bullish_pb_now
        bearish_pb[t] = bearish_pb_now
