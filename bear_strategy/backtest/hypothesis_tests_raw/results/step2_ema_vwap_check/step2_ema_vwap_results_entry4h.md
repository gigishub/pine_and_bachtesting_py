...
── EMA20 / VWAP Setup Edge Verdict ──
  ...
  below_ema20     avg WR lift +0.61pp  avg PF 1.188  avg PF lift +0.031  pairs ≥ threshold: 1/5  ❌
    BTCUSDT     WR 42.82%  lift -0.41pp / req 2.01pp  PF 1.123  lift -0.019 / req 0.100  trades 3,814  cov 64.8%  ❌
    ETHUSDT     WR 41.83%  lift -0.17pp / req 2.01pp  PF 1.079  lift -0.008 / req 0.100  trades 3,770  cov 63.1%  ❌
    SOLUSDT     WR 44.61%  lift +0.55pp / req 2.06pp  PF 1.208  lift +0.026 / req 0.100  trades 3,643  cov 65.3%  ❌
    BNBUSDT     WR 47.51%  lift +2.44pp / req 2.22pp  PF 1.358  lift +0.127 / req 0.100  trades 3,149  cov 62.4%  ✅
    XRPUSDT     WR 43.85%  lift +0.62pp / req 1.95pp  PF 1.172  lift +0.029 / req 0.100  trades 4,018  cov 65.4%  ❌

  below_vwap      avg WR lift +0.65pp  avg PF 1.188  avg PF lift +0.031  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 43.37%  lift +0.15pp / req 2.24pp  PF 1.149  lift +0.007 / req 0.100  trades 3,048  cov 51.8%  ❌
    ETHUSDT     WR 43.15%  lift +1.15pp / req 2.22pp  PF 1.138  lift +0.052 / req 0.100  trades 3,101  cov 51.9%  ❌
    SOLUSDT     WR 44.46%  lift +0.40pp / req 2.28pp  PF 1.201  lift +0.019 / req 0.100  trades 2,960  cov 53.0%  ❌
    BNBUSDT     WR 46.23%  lift +1.16pp / req 2.43pp  PF 1.290  lift +0.059 / req 0.100  trades 2,626  cov 52.0%  ❌
    XRPUSDT     WR 43.61%  lift +0.38pp / req 2.18pp  PF 1.160  lift +0.018 / req 0.100  trades 3,222  cov 52.4%  ❌

  below_both      avg WR lift +0.94pp  avg PF 1.203  avg PF lift +0.046  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 42.89%  lift -0.33pp / req 2.52pp  PF 1.127  lift -0.015 / req 0.100  trades 2,413  cov 41.0%  ❌
    ETHUSDT     WR 43.44%  lift +1.44pp / req 2.52pp  PF 1.152  lift +0.066 / req 0.100  trades 2,394  cov 40.1%  ❌
    SOLUSDT     WR 44.91%  lift +0.85pp / req 2.58pp  PF 1.223  lift +0.041 / req 0.100  trades 2,307  cov 41.3%  ❌
    BNBUSDT     WR 47.24%  lift +2.18pp / req 2.76pp  PF 1.343  lift +0.113 / req 0.100  trades 2,032  cov 40.3%  ❌
    XRPUSDT     WR 43.80%  lift +0.57pp / req 2.45pp  PF 1.169  lift +0.027 / req 0.100  trades 2,548  cov 41.5%  ❌

  below_vwap_1std  avg WR lift +1.30pp  avg PF 1.218  avg PF lift +0.062  pairs ≥ threshold: 0/5  ❌
    BTCUSDT     WR 44.59%  lift +1.37pp / req 3.19pp  PF 1.207  lift +0.065 / req 0.100  trades 1,507  cov 25.6% ⚠️  ❌
    ETHUSDT     WR 44.54%  lift +2.54pp / req 3.22pp  PF 1.205  lift +0.119 / req 0.100  trades 1,466  cov 24.5% ⚠️  ❌
    SOLUSDT     WR 45.06%  lift +1.00pp / req 3.22pp  PF 1.230  lift +0.049 / req 0.100  trades 1,487  cov 26.6% ⚠️  ❌
    BNBUSDT     WR 45.74%  lift +0.68pp / req 3.51pp  PF 1.265  lift +0.034 / req 0.100  trades 1,257  cov 24.9% ⚠️  ❌
    XRPUSDT     WR 44.13%  lift +0.90pp / req 3.13pp  PF 1.185  lift +0.042 / req 0.100  trades 1,566  cov 25.5% ⚠️  ❌
