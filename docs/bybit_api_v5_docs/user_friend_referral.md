...
GET`/v5/user/invitation/referrals`Copy
...
[PreviousDelete Sub API Key](https://bybit-exchange.github.io/docs/v5/user/rm-sub-apikey)[NextGet Instruments Info](https://bybit-exchange.github.io/docs/v5/spread/market/instrument)
