...
> **Source:** https://bybit-exchange.github.io/docs/v5/spread/trade/open-order
...
GET`/v5/spread/order/realtime`Copy
...
[PreviousCancel All Orders](https://bybit-exchange.github.io/docs/v5/spread/trade/cancel-all)[NextGet Order History](https://bybit-exchange.github.io/docs/v5/spread/trade/order-history)
