...
> **Source:** https://vectorbt.dev/api/generic/ranges/
...
generic 
      ...
      * ranges  [ ranges  ](https://vectorbt.dev/api/generic/ranges/) Table of contents 
        * From accessors 
        * Stats 
        * Plots 
...
# ranges module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶
...
See [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.generic.stats_builder.StatsBuilderMixin.stats") and [Ranges.metrics](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges.metrics "vectorbt.generic.ranges.Ranges.metrics").
...
[StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.generic.ranges.Ranges.stats") also supports (re-)grouping:
...
See [PlotsBuilderMixin.plots()](https://vectorbt.dev/api/generic/plots_builder/#vectorbt.generic.plots_builder.PlotsBuilderMixin.plots "vectorbt.generic.plots_builder.PlotsBuilderMixin.plots") and [Ranges.subplots](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges.subplots "vectorbt.generic.ranges.Ranges.subplots").

[Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges") class has a single subplot based on [Ranges.plot()](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges.plot "vectorbt.generic.ranges.Ranges.plot"):
...
## ranges_attach_field_config Config[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶

Config of fields to be attached to [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
...
## ranges_field_config Config[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶

Field config for [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
...
## Ranges class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L190-L654 "Jump to source")¶
...
Requires `records_arr` to have all fields defined in [range_dt](https://vectorbt.dev/api/generic/enums/#vectorbt.generic.enums.range_dt "vectorbt.generic.enums.range_dt").
...
**Subclasses**
  ...
  * [Drawdowns](https://vectorbt.dev/api/generic/drawdowns/#vectorbt.generic.drawdowns.Drawdowns "vectorbt.generic.drawdowns.Drawdowns")
...
### avg_duration method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L290-L295 "Jump to source")¶
...
### closed method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶
...
### coverage method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L304-L325 "Jump to source")¶
...
See [range_coverage_nb()](https://vectorbt.dev/api/generic/nb/#vectorbt.generic.nb.range_coverage_nb "vectorbt.generic.nb.range_coverage_nb").

* * *

### duration method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

Duration of each range (in raw format).

* * *

### end_idx method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

Mapped array of the field `end_idx`.

* * *

### field_config class variable[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶

Field config of [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
...
### from_ts class method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L229-L259 "Jump to source")¶
...
Build [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges") from time series `ts`.
...
`**kwargs` will be passed to [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
...
### indexing_func method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L215-L227 "Jump to source")¶
...
Perform indexing on [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").

* * *

### max_duration method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L297-L302 "Jump to source")¶
...
### metrics class variable[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶

Metrics supported by [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
    
    
    Config({
        "start": {
            "title": "Start",
            "calc_func": "<function Ranges.<lambda> at 0x7f9596be7ec0>",
            "agg_func": null,
            "tags": "wrapper"
        },
        "end": {
            "title": "End",
            "calc_func": "<function Ranges.<lambda> at 0x7f9596be7f60>",
            "agg_func": null,
            "tags": "wrapper"
        },
        "period": {
            "title": "Period",
            "calc_func": "<function Ranges.<lambda> at 0x7f9596c00040>",
        ...
        "duration": {
            ...
            "post_calc_func": "<function Ranges.<lambda> at 0x7f9596c000e0>",
            "apply_to_timedelta": true,
            "tags": [
                "ranges",
                "duration"
...
### open method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

Records filtered by `status == 0`.

* * *

### plot method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L408-L624 "Jump to source")¶
...
**`ts_trace_kwargs`** : `dict`
    Keyword arguments passed to `plotly.graph_objects.Scatter` for [Ranges.ts](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges.ts "vectorbt.generic.ranges.Ranges.ts").
...
### plots_defaults property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L626-L638 "Jump to source")¶

Defaults for [PlotsBuilderMixin.plots()](https://vectorbt.dev/api/generic/plots_builder/#vectorbt.generic.plots_builder.PlotsBuilderMixin.plots "vectorbt.generic.ranges.Ranges.plots").

Merges [Records.plots_defaults](https://vectorbt.dev/api/records/base/#vectorbt.records.base.Records.plots_defaults "vectorbt.records.base.Records.plots_defaults") and `ranges.plots` from [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").

* * *

### start_idx method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

Mapped array of the field `start_idx`.

* * *

### stats_defaults property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L329-L341 "Jump to source")¶

Defaults for [StatsBuilderMixin.stats()](https://vectorbt.dev/api/generic/stats_builder/#vectorbt.generic.stats_builder.StatsBuilderMixin.stats "vectorbt.generic.ranges.Ranges.stats").

Merges [Records.stats_defaults](https://vectorbt.dev/api/records/base/#vectorbt.records.base.Records.stats_defaults "vectorbt.records.base.Records.stats_defaults") and `ranges.stats` from [settings](https://vectorbt.dev/api/_settings/#vectorbt._settings.settings "vectorbt._settings.settings").

* * *

### status method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/decorators.py#L325-L339 "Jump to source")¶

Mapped array of the field `status`.

* * *

### subplots class variable[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py "Jump to source")¶

Subplots supported by [Ranges](https://vectorbt.dev/api/generic/ranges/#vectorbt.generic.ranges.Ranges "vectorbt.generic.ranges.Ranges").
...
### to_mask method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L266-L278 "Jump to source")¶
...
See [ranges_to_mask_nb()](https://vectorbt.dev/api/generic/nb/#vectorbt.generic.nb.ranges_to_mask_nb "vectorbt.generic.nb.ranges_to_mask_nb").

* * *

### ts property[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/generic/ranges.py#L261-L264 "Jump to source")¶
