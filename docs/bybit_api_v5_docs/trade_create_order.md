...
> **Source:** https://bybit-exchange.github.io/docs/v5/spread/trade/create-order
...
POST`/v5/spread/order/create`Copy
...
[PreviousGet Recent Public Trades](https://bybit-exchange.github.io/docs/v5/spread/market/recent-trade)[NextAmend Order](https://bybit-exchange.github.io/docs/v5/spread/trade/amend-order)
