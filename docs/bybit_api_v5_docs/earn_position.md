...
> **Source:** https://bybit-exchange.github.io/docs/v5/earn/position
...
> autoReinvest| string| Auto-reinvest status. `Enable`: enabled, `Disable`: disabled. See [Modify Position](https://bybit-exchange.github.io/docs/v5/earn/modify-position)  
...
[PreviousGet Stake/Redeem Order History](https://bybit-exchange.github.io/docs/v5/earn/order-history)[NextModify Position](https://bybit-exchange.github.io/docs/v5/earn/modify-position)
