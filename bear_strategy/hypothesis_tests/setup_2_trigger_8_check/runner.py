"""Vectorized outcome engine for Setup 2 – Trigger 8: rsi_ma reinforced baseline.

Entry TF : configurable (default 1h)
KDE TF   : 4h  — kde_upper gate shifted 1 completed bar, forward-filled to entry TF
Baseline : regime AND kde_upper AND rsi_ma_below_threshold — all test populations
           are strict subsets of this reinforced baseline.
"""
...
from bear_strategy.hypothesis_tests.setup_2_trigger_8_check.entries import build_population_masks
