...
class BearSignalLogger:
    """Write one JSON per entry signal to disk before order placement."""

    def __init__(self, cfg: BearLiveConfig, log_dir: Path | str | None = None) -> None:
