...
> **Source:** https://bybit-exchange.github.io/docs/v5/asset/balance/asset-overview
...
GET`/v5/asset/asset-overview`Copy
...
> [accountType](https://bybit-exchange.github.io/docs/v5/enum#assetaccounttype)| string| Account type  
...
>> [category](https://bybit-exchange.github.io/docs/v5/enum#assetcategory)| string| Sub-category name  
...
[PreviousGet Withdrawable Amount](https://bybit-exchange.github.io/docs/v5/asset/balance/delay-amount)[NextCreate Internal Transfer](https://bybit-exchange.github.io/docs/v5/asset/transfer/create-inter-transfer)
