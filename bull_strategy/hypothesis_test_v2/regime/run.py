...
Usage (from project root with .venv active):
    python -m bull_strategy.hypothesis_test_v2.regime.run
    # or
    python bull_strategy/hypothesis_test_v2/regime/run.py
...
long opportunities than chance.
...
from bull_strategy.hypothesis_test_v2.regime.config import BASELINE, ENTRY_TIMEFRAMES, IDEAS, PAIRS, THRESHOLDS
