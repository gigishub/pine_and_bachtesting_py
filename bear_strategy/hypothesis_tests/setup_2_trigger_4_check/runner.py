"""Vectorized outcome engine for Setup 2 – Trigger 4: positional filters.
...
from bear_strategy.hypothesis_tests.setup_2_trigger_4_check.entries import build_population_masks
...
def run_test(config: TestConfig) -> pd.DataFrame:
    """Run the trigger-4 check across all configured pairs."""
    params = Parameters(
