...
> **Source:** https://bybit-exchange.github.io/docs/v5/asset/deposit/sub-deposit-record
...
GET`/v5/asset/deposit/query-sub-member-record`Copy
...
> [status](https://bybit-exchange.github.io/docs/v5/enum#depositstatus)| integer| Deposit status  
...
[RUN >>](https://bybit-exchange.github.io/docs/api-explorer/v5/asset/sub-deposit-record)
...
[PreviousGet Deposit Records (on-chain)](https://bybit-exchange.github.io/docs/v5/asset/deposit/deposit-record)[NextGet Internal Deposit Records (off-chain)](https://bybit-exchange.github.io/docs/v5/asset/deposit/internal-deposit-record)
