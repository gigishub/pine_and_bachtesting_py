...
> **Source:** https://vectorbt.dev/api/messaging/
...
# messaging package[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/messaging/__init__.py "Jump to source")¶
...
## Sub-modules¶
  ...
  * [vectorbt.messaging.telegram](https://vectorbt.dev/api/messaging/telegram/ "vectorbt.messaging.telegram")
