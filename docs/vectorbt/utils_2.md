...
> **Source:** https://vectorbt.dev/api/utils/docs/
...
utils 
      ...
      * docs  [ docs  ](https://vectorbt.dev/api/utils/docs/) Table of contents 
        * prepare_for_doc() 
        * to_doc() 
        * Documented() 
          * to_doc() 
...
# docs module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py "Jump to source")¶

Utilities for documentation.

* * *

## prepare_for_doc function[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py#L35-L66 "Jump to source")¶
...
## to_doc function[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py#L69-L72 "Jump to source")¶
...
## Documented class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py#L13-L28 "Jump to source")¶
...
Won't get converted into a string in [prepare_for_doc()](https://vectorbt.dev/api/utils/docs/#vectorbt.utils.docs.prepare_for_doc "vectorbt.utils.docs.prepare_for_doc").

**Subclasses**

  * [Config](https://vectorbt.dev/api/utils/config/#vectorbt.utils.config.Config "vectorbt.utils.config.Config")
...
### to_doc method[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py#L19-L21 "Jump to source")¶
...
## SafeToStr class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/utils/docs.py#L31-L32 "Jump to source")¶
    
    
    SafeToStr()
    

Class that can be safely converted into a string in [prepare_for_doc()](https://vectorbt.dev/api/utils/docs/#vectorbt.utils.docs.prepare_for_doc "vectorbt.utils.docs.prepare_for_doc").

**Subclasses**

  * [Rep](https://vectorbt.dev/api/utils/template/#vectorbt.utils.template.Rep "vectorbt.utils.template.Rep")
  * [RepEval](https://vectorbt.dev/api/utils/template/#vectorbt.utils.template.RepEval "vectorbt.utils.template.RepEval")
  * [RepFunc](https://vectorbt.dev/api/utils/template/#vectorbt.utils.template.RepFunc "vectorbt.utils.template.RepFunc")
  * [Sub](https://vectorbt.dev/api/utils/template/#vectorbt.utils.template.Sub "vectorbt.utils.template.Sub")
