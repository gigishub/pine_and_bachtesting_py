...
> **Source:** https://bybit-exchange.github.io/docs/v5/rfq/trade/rfq-list
...
info
  ...
  * Obtain historical RFQs. This data is not real-time. Please see [Get RFQs (real-time)](https://bybit-exchange.github.io/docs/v5/rfq/trade/rfq-realtime).
...
[PreviousGet RFQs (real-time)](https://bybit-exchange.github.io/docs/v5/rfq/trade/rfq-realtime)[NextGet Quotes (real-time)](https://bybit-exchange.github.io/docs/v5/rfq/trade/quote-realtime)
