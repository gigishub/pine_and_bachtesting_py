...
> **Source:** https://bybit-exchange.github.io/docs/v5/pre-upgrade/close-pnl
...
GET`/v5/pre-upgrade/position/closed-pnl`Copy
...
[PreviousGet Pre-upgrade Trade History](https://bybit-exchange.github.io/docs/v5/pre-upgrade/execution)[NextGet Pre-upgrade Transaction Log](https://bybit-exchange.github.io/docs/v5/pre-upgrade/transaction-log)
