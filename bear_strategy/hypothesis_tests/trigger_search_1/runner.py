"""Vectorized outcome engine for Trigger Search 1.

Entry TF : configurable (default 1h)
KDE TF   : 4h  — kde_upper gate shifted 1 completed bar, forward-filled to entry TF
Baseline : regime AND kde_upper AND rsi_ma_below_threshold (two-layer confirmed gate).
Triggers : 7 event signals — each fires on ONE specific bar within the baseline.
"""
...
from bear_strategy.hypothesis_tests.trigger_search_1.entries import build_population_masks
