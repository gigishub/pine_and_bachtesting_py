"""Position-sizing helpers for the UPS strategy.

Pure functions: return order size as a fraction of equity.
...
def compute_long_size_fraction(
    ...
    """Return order size as fraction of current equity based on risk-per-trade (long).
...
def compute_short_size_fraction(
    ...
    """Return order size as fraction of current equity based on risk-per-trade (short)."""
