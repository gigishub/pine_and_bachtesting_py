...
Populations per pair:
    ...
    ema_cross_below   — regime + close crossed below EMA this bar
    ema_cross_below_N — regime + cross AND min_bars_above consecutive bars
                        above EMA before the cross
"""
...
from bear_strategy.hypothesis_tests.setup_ema_cross_edge_check.entries import (
...
def run_test(config: TestConfig) -> pd.DataFrame:
    """Run the EMA cross-below setup edge check across all configured pairs.
