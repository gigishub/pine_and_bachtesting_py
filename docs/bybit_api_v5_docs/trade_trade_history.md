...
> **Source:** https://bybit-exchange.github.io/docs/v5/spread/trade/trade-history
...
info
  ...
  * Single leg executions can also be found with "execType"=`FutureSpread` via [Get Trade History](https://bybit-exchange.github.io/docs/v5/order/execution)



### HTTP Request​

GET`/v5/spread/execution/list`Copy
...
>> [execType](https://bybit-exchange.github.io/docs/v5/enum#exectype)| string| Leg exec type  
...
[PreviousGet Order History](https://bybit-exchange.github.io/docs/v5/spread/trade/order-history)[NextConnect](https://bybit-exchange.github.io/docs/v5/ws/connect)
