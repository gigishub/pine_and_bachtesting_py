...
GET`/v5/affiliate/aff-user-list`Copy
...
[PreviousRFQ](https://bybit-exchange.github.io/docs/v5/rfq/websocket/private/inquiry)[NextGet Affiliate User Info](https://bybit-exchange.github.io/docs/v5/affiliate/affiliate-info)
