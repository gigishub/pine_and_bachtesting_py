...
list| array| Object  
> [positionIdx](https://bybit-exchange.github.io/docs/v5/enum#positionidx)| integer| Position idx, used to identify positions in different position modes
...
[RUN >>](https://bybit-exchange.github.io/docs/api-explorer/v5/position/position-info)
...
[PreviousPre Check Order](https://bybit-exchange.github.io/docs/v5/order/pre-check-order)[NextSet Leverage](https://bybit-exchange.github.io/docs/v5/position/leverage)
