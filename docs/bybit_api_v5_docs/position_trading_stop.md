...
[positionIdx](https://bybit-exchange.github.io/docs/v5/enum#positionidx)| true| integer| Used to identify positions in different position modes. 
...
[PreviousSwitch Position Mode](https://bybit-exchange.github.io/docs/v5/position/position-mode)[NextSet Auto Add Margin](https://bybit-exchange.github.io/docs/v5/position/auto-add-margin)
