...
> **Source:** https://vectorbt.dev/api/data/
...
# data package[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/data/__init__.py "Jump to source")¶
...
## Sub-modules¶
  ...
  * [vectorbt.data.base](https://vectorbt.dev/api/data/base/ "vectorbt.data.base")
  * [vectorbt.data.custom](https://vectorbt.dev/api/data/custom/ "vectorbt.data.custom")
  * [vectorbt.data.updater](https://vectorbt.dev/api/data/updater/ "vectorbt.data.updater")
