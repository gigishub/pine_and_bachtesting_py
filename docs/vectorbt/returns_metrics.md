...
> **Source:** https://vectorbt.dev/api/returns/metrics/
...
returns 
      ...
      * metrics  [ metrics  ](https://vectorbt.dev/api/returns/metrics/) Table of contents 
...
# metrics module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/returns/metrics.py "Jump to source")¶

Other metrics that are not compiled with Numba.

* * *

## approx_exp_max_sharpe function[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/returns/metrics.py#L12-L15 "Jump to source")¶
...
## deflated_sharpe_ratio function[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/returns/metrics.py#L18-L26 "Jump to source")¶
