"""Vectorized outcome engine for Setup 2 – Trigger 2: momentum-flip signals.
...
from bear_strategy.hypothesis_tests.setup_2_trigger_2_check.entries import build_population_masks
...
def run_test(config: TestConfig) -> pd.DataFrame:
    """Run the trigger-2 momentum-flip check across all configured pairs."""
    params = Parameters(
