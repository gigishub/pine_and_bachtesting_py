...
Result files:
    step2_ema_cross_results_entry{entry_tf}_N{min_bars_above}.csv
    step2_ema_cross_results_entry{entry_tf}_N{min_bars_above}.md
...
def main() -> None:
    ...
    stem = f"step2_ema_cross_results_entry{config.entry_tf}_N{config.min_bars_above}"
