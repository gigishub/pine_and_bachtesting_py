...
GET`/v5/user/aff-customer-info`Copy
...
[RUN >>](https://bybit-exchange.github.io/docs/api-explorer/v5/user/affiliate-info)
...
[PreviousGet Affiliate User List](https://bybit-exchange.github.io/docs/v5/affiliate/affiliate-user-list)[NextGet VIP Margin Data](https://bybit-exchange.github.io/docs/v5/spot-margin-uta/vip-margin)
