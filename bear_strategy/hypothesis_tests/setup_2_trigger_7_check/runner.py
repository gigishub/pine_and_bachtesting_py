"""Vectorized outcome engine for Setup 2 – Trigger 7: exhaustion signals.
...
from bear_strategy.hypothesis_tests.setup_2_trigger_7_check.entries import build_population_masks
