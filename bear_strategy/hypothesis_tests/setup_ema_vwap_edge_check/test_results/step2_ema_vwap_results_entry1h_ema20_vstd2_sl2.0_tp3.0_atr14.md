# Bear Strategy — EMA20 / VWAP Setup Edge Check  (entry_tf=1h)
...
── EMA20 / VWAP Setup Edge Verdict ──
  ...
  below_ema20     avg WR lift +0.84pp  avg PF 1.288  avg PF lift +0.043  pairs ≥ threshold: 1/5  ❌  ⚠️ WR 5p
    BTCUSDT     WR 45.25%  lift +0.87pp / req 1.09pp  PF 1.240  lift +0.043 / req 0.050  trades 13,016  cov 55.3%  ⚠️ WR  ❌
    ETHUSDT     WR 46.00%  lift +0.73pp / req 1.08pp  PF 1.278  lift +0.037 / req 0.050  trades 13,184  cov 55.2%  ⚠️ WR  ❌
    SOLUSDT     WR 45.89%  lift +1.05pp / req 1.10pp  PF 1.272  lift +0.053 / req 0.050  trades 12,803  cov 57.2%  ⚠️ WR  ✅
    BNBUSDT     WR 45.79%  lift +0.86pp / req 1.19pp  PF 1.267  lift +0.043 / req 0.050  trades 10,902  cov 53.9%  ⚠️ WR  ❌
    XRPUSDT     WR 48.00%  lift +0.71pp / req 1.06pp  PF 1.385  lift +0.039 / req 0.050  trades 13,953  cov 56.7%  ⚠️ WR  ❌

  below_vwap      avg WR lift +0.66pp  avg PF 1.279  avg PF lift +0.034  pairs ≥ threshold: 1/5  ❌  ⚠️ WR 5p
    BTCUSDT     WR 44.66%  lift +0.28pp / req 1.13pp  PF 1.211  lift +0.014 / req 0.050  trades 12,113  cov 51.4%  ⚠️ WR  ❌
    ETHUSDT     WR 46.33%  lift +1.05pp / req 1.12pp  PF 1.295  lift +0.054 / req 0.050  trades 12,335  cov 51.6%  ⚠️ WR  ✅
    SOLUSDT     WR 45.16%  lift +0.32pp / req 1.14pp  PF 1.235  lift +0.016 / req 0.050  trades 11,884  cov 53.1%  ⚠️ WR  ❌
    BNBUSDT     WR 45.86%  lift +0.93pp / req 1.21pp  PF 1.271  lift +0.047 / req 0.050  trades 10,477  cov 51.8%  ⚠️ WR  ❌
    XRPUSDT     WR 48.00%  lift +0.71pp / req 1.10pp  PF 1.385  lift +0.039 / req 0.050  trades 12,918  cov 52.5%  ⚠️ WR  ❌

  below_both      avg WR lift +0.96pp  avg PF 1.295  avg PF lift +0.050  pairs ≥ threshold: 2/5  ❌  ⚠️ WR 3p
    BTCUSDT     WR 44.97%  lift +0.58pp / req 1.23pp  PF 1.226  lift +0.029 / req 0.050  trades 10,125  cov 43.0%  ⚠️ WR  ❌
    ETHUSDT     WR 46.31%  lift +1.04pp / req 1.22pp  PF 1.294  lift +0.053 / req 0.050  trades 10,431  cov 43.6%  ⚠️ WR  ✅
    SOLUSDT     WR 45.32%  lift +0.48pp / req 1.24pp  PF 1.243  lift +0.024 / req 0.050  trades 10,099  cov 45.1%  ⚠️ WR  ❌
  ...
  below_vwap_1std  avg WR lift -0.59pp  avg PF 1.217  avg PF lift -0.028  pairs ≥ threshold: 0/5  ❌  ⚠️ WR 5p  ⚠️ low count 5p
    BTCUSDT     WR 42.82%  lift -1.56pp / req 2.41pp  PF 1.124  lift -0.074 / req 0.100  trades 2,662  cov 11.3% ⚠️  ⚠️ WR  ❌
    ETHUSDT     WR 44.97%  lift -0.30pp / req 2.45pp  PF 1.226  lift -0.015 / req 0.100  trades 2,586  cov 10.8% ⚠️  ⚠️ WR  ❌
    SOLUSDT     WR 43.37%  lift -1.46pp / req 2.36pp  PF 1.149  lift -0.070 / req 0.100  trades 2,769  cov 12.4% ⚠️  ⚠️ WR  ❌
    BNBUSDT     WR 45.18%  lift +0.25pp / req 2.51pp  PF 1.236  lift +0.012 / req 0.100  trades 2,457  cov 12.1% ⚠️  ⚠️ WR  ❌
    XRPUSDT     WR 47.40%  lift +0.11pp / req 2.30pp  PF 1.352  lift +0.006 / req 0.100  trades 2,947  cov 12.0% ⚠️  ⚠️ WR  ❌
