...
> **Source:** https://vectorbt.dev/api/labels/enums/
...
labels 
      * enums  [ enums  ](https://vectorbt.dev/api/labels/enums/) Table of contents 
        * TrendMode 
        * TrendModeT() 
          * Binary 
          * BinaryCont 
...
# enums module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶

Named tuples and enumerated types.

Defines enums and other schemas for [vectorbt.labels](https://vectorbt.dev/api/labels/ "vectorbt.labels").

* * *

## TrendMode TrendModeT[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶
...
**`Binary`**
    See [bn_trend_labels_nb()](https://vectorbt.dev/api/labels/nb/#vectorbt.labels.nb.bn_trend_labels_nb "vectorbt.labels.nb.bn_trend_labels_nb").
**`BinaryCont`**
    See [bn_cont_trend_labels_nb()](https://vectorbt.dev/api/labels/nb/#vectorbt.labels.nb.bn_cont_trend_labels_nb "vectorbt.labels.nb.bn_cont_trend_labels_nb").
**`BinaryContSat`**
    See [bn_cont_sat_trend_labels_nb()](https://vectorbt.dev/api/labels/nb/#vectorbt.labels.nb.bn_cont_sat_trend_labels_nb "vectorbt.labels.nb.bn_cont_sat_trend_labels_nb").
**`PctChange`**
    See [pct_trend_labels_nb()](https://vectorbt.dev/api/labels/nb/#vectorbt.labels.nb.pct_trend_labels_nb "vectorbt.labels.nb.pct_trend_labels_nb").
**`PctChangeNorm`**
    See [pct_trend_labels_nb()](https://vectorbt.dev/api/labels/nb/#vectorbt.labels.nb.pct_trend_labels_nb "vectorbt.labels.nb.pct_trend_labels_nb") with `normalize` set to True.

* * *

## TrendModeT class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py#L18-L23 "Jump to source")¶
...
### Binary method-wrapper[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶

Alias for field number 0

* * *

### BinaryCont method-wrapper[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶

Alias for field number 1

* * *

### BinaryContSat method-wrapper[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶

Alias for field number 2

* * *

### PctChange method-wrapper[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶

Alias for field number 3

* * *

### PctChangeNorm method-wrapper[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/enums.py "Jump to source")¶
