...
----------------------
    ...
    BASELINE = {
        ...
        "module":     "bull_strategy.hypothesis_test_v2.regime.indicators.close_below_ema",
        "params":     {"period": 50},
        "context_tf": "1d",
    }
...
from bull_strategy.hypothesis_test_v2.engine.alignment import align_htf_series
from bull_strategy.hypothesis_test_v2.engine.baseline_cache import get_or_compute_baseline
from bull_strategy.hypothesis_test_v2.engine.data_loader import (
    assert_date_range_consistent,
    load_ohlcv,
)
from bull_strategy.hypothesis_test_v2.engine.outcome_engine import compute_outcomes
from bull_strategy.hypothesis_test_v2.reports.active_board import write_active_boards
from bull_strategy.hypothesis_test_v2.reports.phase_csv import append_row
from bull_strategy.hypothesis_test_v2.reports.rejected_archive import append_rejected_by_tf
