...
> **Source:** https://vectorbt.dev/api/signals/factory/
...
signals 
      ...
      * factory  [ factory  ](https://vectorbt.dev/api/signals/factory/) Table of contents 
        * SignalFactory() 
...
# factory module[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/signals/factory.py "Jump to source")¶

A factory for building new signal generators with ease.

The signal factory class [SignalFactory](https://vectorbt.dev/api/signals/factory/#vectorbt.signals.factory.SignalFactory "vectorbt.signals.factory.SignalFactory") extends [IndicatorFactory](https://vectorbt.dev/api/indicators/factory/#vectorbt.indicators.factory.IndicatorFactory "vectorbt.indicators.factory.IndicatorFactory") to offer a convenient way to create signal generators of any complexity. By providing it with information such as entry and exit functions and the names of inputs, parameters, and outputs, it will create a stand-alone class capable of generating signals for an arbitrary combination of inputs and parameters.

* * *

## SignalFactory class[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/signals/factory.py#L33-L950 "Jump to source")¶
...
Extends [IndicatorFactory](https://vectorbt.dev/api/indicators/factory/#vectorbt.indicators.factory.IndicatorFactory "vectorbt.indicators.factory.IndicatorFactory") with choice functions.
...
See [FactoryMode](https://vectorbt.dev/api/signals/enums/#vectorbt.signals.enums.FactoryMode "vectorbt.signals.enums.FactoryMode") for supported generation modes.

Other arguments are passed to [IndicatorFactory](https://vectorbt.dev/api/indicators/factory/#vectorbt.indicators.factory.IndicatorFactory "vectorbt.indicators.factory.IndicatorFactory"). 
    ...
    * [IndicatorFactory.parse_ta_config()](/api/indicators/factory/#vectorbt.indicators.factory.IndicatorFactory.parse_ta_config "vectorbt.indicators.factory.IndicatorFactory.parse_ta_config")
    ...
    ### from_choice_func <span class="dobjtype">method</span><a class="githublink" href="https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/signals/factory.py#L165-L950" target="_blank" title="Jump to source">:material-github:</a> { #vectorbt.signals.factory.SignalFactory.from_choice_func data-toc-label='from_choice_func()' }
...
Defaults to [first_choice_nb()](https://vectorbt.dev/api/signals/nb/#vectorbt.signals.nb.first_choice_nb "vectorbt.signals.nb.first_choice_nb") for `FactoryMode.Chain`.
...
Defaults to [generate_nb()](https://vectorbt.dev/api/signals/nb/#vectorbt.signals.nb.generate_nb "vectorbt.signals.nb.generate_nb").
...
Defaults to [generate_ex_nb()](https://vectorbt.dev/api/signals/nb/#vectorbt.signals.nb.generate_ex_nb "vectorbt.signals.nb.generate_ex_nb").
...
Defaults to [generate_enex_nb()](https://vectorbt.dev/api/signals/nb/#vectorbt.signals.nb.generate_enex_nb "vectorbt.signals.nb.generate_enex_nb").
...
You can also pass `temp_idx_arr1`, `temp_idx_arr2`, etc. to generate multiple. * `flex_2d`: See [flex_select_auto_nb()](https://vectorbt.dev/api/base/reshape_fns/#vectorbt.base.reshape_fns.flex_select_auto_nb "vectorbt.base.reshape_fns.flex_select_auto_nb"). Default is provided by the pipeline if `pass_flex_2d` is True.
...
For more arguments, see [run_pipeline()](https://vectorbt.dev/api/indicators/factory/#vectorbt.indicators.factory.run_pipeline "vectorbt.indicators.factory.run_pipeline").
