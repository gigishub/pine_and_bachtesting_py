...
Usage (from project root with .venv active):
    python -m bull_strategy.hypothesis_test_v2.setup.run
    # or
    python bull_strategy/hypothesis_test_v2/setup/run.py
...
from bull_strategy.hypothesis_test_v2.setup.config import BASELINE, ENTRY_TIMEFRAMES, IDEAS, PAIRS, THRESHOLDS
