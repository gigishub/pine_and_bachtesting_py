...
GET`/v5/fiat/query-coin-list`Copy
...
[PreviousGet Exchange History](https://bybit-exchange.github.io/docs/v5/asset/convert-small-balance/exchange-history)[NextGet Reference Price](https://bybit-exchange.github.io/docs/v5/asset/fiat-convert/reference-price)
