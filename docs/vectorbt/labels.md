...
> **Source:** https://vectorbt.dev/api/labels/
...
# labels package[](https://github.com/polakowo/vectorbt/blob/993ceca7116fc8e55f4cd3a36fe43d83dab62b27/vectorbt/labels/__init__.py "Jump to source")¶
...
## Sub-modules¶
  ...
  * [vectorbt.labels.enums](https://vectorbt.dev/api/labels/enums/ "vectorbt.labels.enums")
  * [vectorbt.labels.generators](https://vectorbt.dev/api/labels/generators/ "vectorbt.labels.generators")
  * [vectorbt.labels.nb](https://vectorbt.dev/api/labels/nb/ "vectorbt.labels.nb")
